...
public class BrickPiFactory extends AbstractRobotFactory {
    private final BrickPiCompilerWorkflow robotCompilerWorkflow;
    private final Ev3SimCompilerWorkflow simCompilerWorkflow;
    private final Properties ev3Properties;
    private final int robotPropertyNumber;
    private final String name;

    public BrickPiFactory(RobotCommunicator robotCommunicator) {
        this.name = "brickpi";
        this.robotPropertyNumber = RobertaProperties.getRobotNumberFromProperty(this.name);
        this.ev3Properties = Util1.loadProperties("classpath:BrickPi.properties");
        this.robotCompilerWorkflow = new BrickPiCompilerWorkflow(RobertaProperties.getTempDirForUserProjects());
        this.simCompilerWorkflow = new Ev3SimCompilerWorkflow();
        addBlockTypesFromProperties("BrickPi.properties", this.ev3Properties);
    }
