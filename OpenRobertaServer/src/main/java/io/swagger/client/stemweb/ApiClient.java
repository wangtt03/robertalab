...
import io.swagger.client.stemweb.auth.Authentication;
import io.swagger.client.stemweb.auth.HttpBasicAuth;
import io.swagger.client.stemweb.auth.ApiKeyAuth;
import io.swagger.client.stemweb.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://virtserver.swaggerhub.com/stemgarden/stemgarden/1.0";
    ...
    public ApiClient() {
        ...
        authentications.put("UserSecurity", new ApiKeyAuth("header", "X-Access-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://virtserver.swaggerhub.com/stemgarden/stemgarden/1.0
