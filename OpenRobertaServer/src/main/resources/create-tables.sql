create table USER (
  ...
  GROUPS_LIST int, -- a link to a table with groups
  primary key (ID)
);
...
create unique index groupsId on GROUPS(NAME);
...
create unique index accountIdx on USER_GROUPS(ACCOUNT);
