...
Blockly.Msg.ENCODER_GETSAMPLE_TOOLTIP = "获取当前马达编码器的值。";
Blockly.Msg.ENCODER_RESET_TOOLTIP = "重置马达的编码器。";
...
Blockly.Msg.MOTOR_GETPOWER_TOOLTIP = "获取当前马达的电量。";
Blockly.Msg.MOTOR_LEFT = "左";
Blockly.Msg.MOTOR_MIDDLE = "中";
Blockly.Msg.MOTOR_MIDDLE_TOOLTIP = "Represents a middle motor.";
Blockly.Msg.MOTOR_NONE = "无";
Blockly.Msg.MOTOR_ON_FOR_TOOLTIP = "启动马达并且使马达转动指定角度后关闭它。";
Blockly.Msg.MOTOR_ON_TOOLTIP = "按下电源按钮打开马达。";
Blockly.Msg.MOTOR_OTHER = "other power consumer";
Blockly.Msg.MOTOR_PAN = "pan";
Blockly.Msg.MOTOR_PORT = "马达端口";
...
Blockly.Msg.SENSOR_TOUCH = "压力传感器";
...
Blockly.Msg.TOOLBOX_COGNITIVE = "认知服务";  // untranslated
